...
CREATE TABLE Terapeuta (
    ID_terapeuta VARCHAR(10) PRIMARY KEY,
    nombre VARCHAR(15) NOT NULL,
    ape_paterno VARCHAR(15) NOT NULL,
    ape_materno VARCHAR(15),
...
CREATE TABLE DireccionConsulta (
    ID_direccionConsulta VARCHAR(10) PRIMARY KEY,
    nombre VARCHAR(50) NOT NULL,
    direccion VARCHAR(50) NOT NULL,
    ID_comuna VARCHAR(10) NOT NULL,
    ID_region VARCHAR(10) NOT NULL,
...
CREATE TABLE ConsultaTerapeuta (
    ...
    ID_direccionConsulta VARCHAR(10) NOT NULL,
    ID_terapeuta VARCHAR(10) NOT NULL,
...
CREATE TABLE MotivoBloqueo (
    ID_motivoBloqueo VARCHAR(10) PRIMARY KEY,
    nombre VARCHAR(20) NOT NULL
);
...
CREATE TABLE Bloqueo (
    ...
    ID_terapeuta VARCHAR(10) NOT NULL,
    ID_motivoBloqueo VARCHAR(10) NOT NULL,
...
CREATE TABLE Atencion (
    ID_atencion VARCHAR(20) PRIMARY KEY,
    ID_terapeuta VARCHAR(10) NOT NULL,
    ID_servicio VARCHAR(10) NOT NULL,
    tamaño_bloque INT,
    duracion_min INT,
...
CREATE TABLE Reserva (
    ...
    ID_paciente VARCHAR(10) NOT NULL,
    ID_terapeuta VARCHAR(10) NOT NULL, -- Nueva clave foránea
    ID_especialidad VARCHAR(10) NOT NULL,  -- Nueva columna para la especialidad
...
CREATE TABLE Calendario (
    ID_calendario VARCHAR(30) PRIMARY KEY,
    ID_atencion VARCHAR(20) NOT NULL,
    ID_terapeuta VARCHAR(10) NOT NULL, -- Nueva clave foránea
    fecha_ini DATE NOT NULL,
    semana_ini VARCHAR(10),
    semana_fin VARCHAR(10),
...
-- Tabla Semana
CREATE TABLE Semana (
    ID_semana VARCHAR(10) PRIMARY KEY,
    ID_calendario VARCHAR(30) NOT NULL,
    fecha DATE NOT NULL,
...
-- Tabla Dia
CREATE TABLE Dia (
    ID_dia VARCHAR(20) PRIMARY KEY,
    ID_semana VARCHAR(10) NOT NULL,
    fecha DATE NOT NULL,
    hora_ini INT,
    hora_fin INT,
    tamaño_bloque INT,
...
-- Tabla Bloque
CREATE TABLE Bloque (
    ID_bloque VARCHAR(30) PRIMARY KEY,
...
INSERT INTO ServicioTerapeuta (ID_servicio, ID_terapeuta) VALUES
-- Terapeutas de Masajes
('SER001', 'TER001'), -- Masaje relajación
('SER002', 'TER002'), -- Masaje descontracturante
('SER003', 'TER003'), -- Masaje linfático

-- Terapeutas de Holístico
('SER004', 'TER004'), -- Reiki
('SER005', 'TER005'), -- Terapia floral
('SER006', 'TER006'), -- Aromaterapia

-- Terapeutas de Deportivo
('SER007', 'TER007'), -- Terapia física
('SER008', 'TER008'), -- Taping
